      ...
      <form class="add-task-modal">
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="flex justify-between table-heading">
            <h4 class="flex justify-center items-center font-bold">Add New Task</h4>
          </div>
          <div class="py-3">
            <div class="mb-4">
            ...
            <div class="mb-4">
              ...
              <input type="number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Enter No of images" wire:model="no_of_images">
