    ...
    <div class="container mx-auto py-12">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <div class="flex justify-between table-heading">
                <h5 class="flex justify-center items-center text-lg font-bold text-gray-700">Staff List</h5>
                <button wire:click="create()"
                    class="bg-dark-blue hover:bg-blue-700 text-white font-medium text-sm py-2 px-4 rounded my-3">Add
                    Staff</button>
            </div>
            @if ($isOpen)
